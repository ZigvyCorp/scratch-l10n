...
export default {
  ...
  "en": {
    ...
    "widget.whenButtonClicked": "when button [NAME] clicked",
    ...
    "widget.setWidgetStyle": "set background color [BGCOLOR] border color [BORDERCOLOR] border radius [BORDERRADIUS] for widget [NAME]",
    ...
    "widget.addImage": "add image [COSTUME] to widget named [NAME] with position X [X] Y [Y]",
  ...
  "es": {
    ...
    "widget.addImage": "agregue la imagen [COSTUME] al widget llamado [NAME] con la posición X [X] Y [Y]",
    "widget.menuItem.single": "soltera",
    "widget.menuItem.multiple": "múltiple",
    "widget.menuItem.scroll": "desplazarse",
    "widget.menuItem.noScroll": "sin desplazamiento",
    "widget.menuItem.input": "aporte",
    "widget.menuItem.readOnly": "solo lectura",
    "widget.menuItem.normal": "normal",
    "widget.menuItem.bold": "negrita",
    "widget.menuItem.show": "show",
    "widget.menuItem.hide": "esconder"
  },
  "es-419": {
    "boost.color.any": "de cualquier color",
    "boost.color.black": "negra",
  ...
  "fr": {
    ...
    "widget.addImage": "ajouter une image [COSTUME] au widget nommé [NAME] avec la position X [X] Y [Y]",
    "widget.menuItem.single": "célibataire",
    "widget.menuItem.multiple": "plusieurs",
    "widget.menuItem.scroll": "faire défiler",
    "widget.menuItem.noScroll": "pas de défilement",
    "widget.menuItem.input": "saisir",
    "widget.menuItem.readOnly": "lecture seulement",
    "widget.menuItem.normal": "ordinaire",
    "widget.menuItem.bold": "gras",
    "widget.menuItem.show": "spectacle",
    "widget.menuItem.hide": "cacher"
  },
  "fy": {
  ...
  "zh-cn": {
    ...
    "widget.addTextbox": "添加文本框 位置 X [X] Y [Y] 宽度 [WIDTH] 高度 [HEIGHT] 行数 [MULTIPLELINE] 滚动 [SCROLL] 模式 [MODE] 名为 [NAME]",
    "widget.valueFromWidget": "名为 [NAME] 的控件的读值",
    "widget.setText": "将文本框 [NAME] 的内容设置为 [TEXT]",
    "widget.appendText": "将 [TEXT] 附加到文本框 [NAME]",
    "widget.addLabel": "添加标签 文字 [TEXT] X [X] Y [Y] 宽度 [WIDTH] 高度 [HEIGHT] 名为 [NAME]",
    "widget.addButton": "添加按钮 文字 [TEXT] X [X] Y [Y] 宽度 [WIDTH] 高度 [HEIGHT] 提示 [TOOLTIP] 名为 [NAME]",
    "widget.addDatePicker": "添加日期选择器 X [X] Y [Y] 名为 [NAME]",
    "widget.addColorPicker": "添加颜色选择器 X [X] Y [Y] 名为 [NAME]",
    "widget.addSlider": "添加滑动条 X [X] Y [Y] 最小值　[MIN] 最大值 [MAX] 名为 [NAME]",
    "widget.addMenu": "添加菜单  X [X] Y [Y] 列表 [LIST] 名为 [NAME]",
    "widget.whenButtonClicked": "当名为 [NAME] 的按钮被点击的时候",
    "widget.whenWidgetChanges": "当名为 [NAME] 的控件更改时",
    "widget.setTextStyle": "为控件 [NAME] 设置 字体 [FONT] 大小 [FONTSIZE] 颜色 [TEXTCOLOR] 粗度 [BOLDNESS]",
    "widget.setWidgetStyle": "为控件 [NAME] 设置 背景颜色 [BGCOLOR] 边框颜色 [BORDERCOLOR] 边框半径 [BORDERRADIUS]",
    "widget.removeWidget": "删除名为 [NAME] 的控件",
    "widget.removeAllWidgets": "删除本角色的所有控件",
    "widget.setVisibility": "设置名为 [NAME] 的控件可见性 [VISIBILITY]",
    "widget.setVisibilityForAll": "为所有控件设置可见性 [VISIBILITY]",
    "widget.whenMouseOver": "当指针位于名为 [NAME] 的控件上时",
    "widget.addImage": "将图像 [COSTUME] 添加到名为 [NAME] 的小部件，位置为 X [X] Y [Y]",
    "widget.menuItem.single": "单身的",
    "widget.menuItem.multiple": "多",
    "widget.menuItem.scroll": "滚动",
    "widget.menuItem.noScroll": "没有滚动",
    "widget.menuItem.input": "输入",
    "widget.menuItem.readOnly": "只读",
    "widget.menuItem.normal": "普通的",
    "widget.menuItem.bold": "胆大",
    "widget.menuItem.show": "展示",
    "widget.menuItem.hide": "隐藏"
  },
  "zh-tw": {
