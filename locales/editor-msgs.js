...
export default {
  "en": {
    ...
    "widget.addTextbox": "add textbox at X [X] Y [Y] width [WIDTH] height [HEIGHT] text color [TEXTCOLOR] background color [BGCOLOR] border color [BORDERCOLOR] border radius [BORDERRADIUS] line [MULTIPLELINE] scroll [SCROLL] mode [MODE] named [NAME]",
    "widget.textFromName": "text from textbox [NAME]",
    "widget.setText": "set text to [TEXT] for textbox [NAME]",
    "widget.appendText": "append text [TEXT] to textbox [NAME]",
    "widget.addLabel": "add label [TEXT] at X [X] Y [Y] width [WIDTH] height [HEIGHT] text color [TEXTCOLOR] background color [BGCOLOR] border color [BORDERCOLOR] border radius [BORDERRADIUS] named [NAME]",
    "widget.addButton": "add button [TEXT] at X [X] Y [Y] width [WIDTH] height [HEIGHT] text color [TEXTCOLOR] background color [BGCOLOR] border color [BORDERCOLOR] border radius [BORDERRADIUS] named [NAME]",
    "widget.whenButtonClicked": "when button named [NAME] clicked",
    "widget.whenTextBoxChanges": "when textbox named [NAME] changes",
  ...
  "es": {
    ...
    "widget.addTextbox": "agregar cuadro de texto en X [X] Y [Y] ancho [WIDTH] alto [HEIGHT] color de texto [TEXTCOLOR] color de fondo [BGCOLOR] color del borde [BORDERCOLOR] radio del borde [BORDERRADIUS] línea [MULTIPLELINE] modo de desplazamiento [SCROLL] [MODE] llamado [NAME]",
    "widget.textFromName": "texto del cuadro de texto [NAME]",
    ...
    "widget.addLabel": "añadir etiqueta [TEXT] a X [X] Y [Y] ancho [WIDTH] alto [HEIGHT] color de texto [TEXTCOLOR] color de fondo [BGCOLOR] color del borde [BORDERCOLOR] radio del borde [BORDERRADIUS] llamado [NAME]",
    "widget.addButton": "agregar botón [TEXT] a X [X] Y [Y] ancho [WIDTH] alto [HEIGHT] color del texto [TEXTCOLOR] color de fondo [BGCOLOR] color del borde [BORDERCOLOR] radio del borde [BORDERRADIUS] llamado [NAME]",
    "widget.whenButtonClicked": "cuando se hace clic en el botón llamado [NAME]",
    "widget.whenTextBoxChanges": "cuando cambia el cuadro de texto llamado [NAME]",
  ...
  "fr": {
    ...
    "widget.addTextbox": "ajouter une zone de texte à X [X] Y [Y] largeur [WIDTH] hauteur [HEIGHT] couleur du texte [TEXTCOLOR] couleur d'arrière-plan [BGCOLOR] couleur de la bordure [BORDERCOLOR] rayon de la bordure [BORDERRADIUS] ligne [MULTIPLELINE] scroll [SCROLL] mode [MODE] nommé [NAME]",
    "widget.textFromName": "texte de la zone de texte [NAME]",
    ...
    "widget.addLabel": "ajouter une étiquette [TEXT] à X [X] Y [Y] largeur [WIDTH] hauteur [HEIGHT] couleur du texte [TEXTCOLOR] couleur d'arrière-plan [BGCOLOR] couleur de la bordure [BORDERCOLOR] rayon de la bordure [BORDERRADIUS] nommé [NAME]",
    "widget.addButton": "ajouter un bouton [TEXT] à X [X] Y [Y] largeur [WIDTH] hauteur [HEIGHT] couleur du texte [TEXTCOLOR] couleur d'arrière-plan [BGCOLOR] couleur de la bordure [BORDERCOLOR] rayon de la bordure [BORDERRADIUS] nommé [NAME]",
    "widget.whenButtonClicked": "lorsque le bouton nommé [NAME] a cliqué",
    "widget.whenTextBoxChanges": "lorsque la zone de texte nommée [NAME] change",
  ...
  "zh-cn": {
    ...
    "widget.categoryName": "钢笔",
    "widget.addTextbox": "添加文本框 位置　X [X] Y [Y] 宽度 [WIDTH] 高度 [HEIGHT] 文字颜色 [TEXTCOLOR] 背景颜色 [BGCOLOR] 边框颜色 [BORDERCOLOR] 边框半径 [BORDERRADIUS] 行 [MULTIPLELINE] 滚动 [SCROLL] 模式 [ MODE] 名为 [NAME]",
    "widget.textFromName": "文本框 [NAME] 内的文字",
    "widget.setText": "将 [NAME] 的文本设置为 [TEXT]",
    "widget.appendText": "将 [TEXT] 附加到文本框 [NAME]",
    "widget.addLabel": "添加标签 [TEXT] 位置 X [X] Y [Y] 宽度 [WIDTH] 高度 [HEIGHT] 文本颜色 [TEXTCOLOR] 背景颜色 [BGCOLOR] 边框颜色 [BORDERCOLOR] 边框半径 [BORDERRADIUS] 命名为 [NAME]",
    "widget.addButton": "添加按钮 [TEXT] 位置 X [X] Y [Y] 宽度 [WIDTH] 高度 [HEIGHT] 文本颜色 [TEXTCOLOR] 背景颜色 [BGCOLOR] 边框颜色 [BORDERCOLOR] 边框半径 [BORDERRADIUS] 命名为 [NAME]",
    "widget.whenButtonClicked": "当名为 [NAME] 的按钮被点击的时候",
    "widget.whenTextBoxChanges": "当名为 [NAME] 的文本框被更改时",
